module.exports = {
	...
	"keys": {
		...
		"searchEmails_placeholder": "Search mails",
		...
		"payChangeError_msg": "The payment transaction failed. Paying with provided payment data is not possible. Please change your payment data.",
